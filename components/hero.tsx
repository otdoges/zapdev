...
export default function Hero() {
  ...
  if (!mounted) {
    return (
      <section className="relative min-h-screen overflow-hidden flex flex-col items-center justify-center px-4 py-20 md:py-32 bg-[#0D0D10]">
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-[#EAEAEA]/80 max-w-3xl mx-auto mb-10">
    ...
    <section className="relative min-h-screen overflow-hidden flex flex-col items-center justify-center px-4 py-20 md:py-32">
      ...
      >
        ...
        >
          ...
          <Button 
            variant="outline" 
            className="text-lg py-6 px-8 rounded-full border-[#4F3A75] hover:border-[#7A3F6D] hover:bg-[#0D0D10]/50 text-white"
