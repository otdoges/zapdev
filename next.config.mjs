...
const nextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      "connect-src 'self' http://localhost:3000 http://localhost:3001 https://api.github.com https://funky-humpback-59.clerk.accounts.dev https://cdn.jsdelivr.net wss://original-meerkat-657.convex.cloud",
